...
\tikzexternaldisable
\usepackage{geometry}
\geometry{letterpaper, left=.6in,right=.6in,top=.6in,bottom=.7in,marginparwidth=.55in, % Adjust the width of the marginpar
...
\newif\iftikzX % if you use \tikzXtrue/\tikzXfalse anywhere
